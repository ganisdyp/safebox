...
use common\models\ActivityTypeLang;
...
<?php $this->registerJs("
    $('.delete-button-photo').click(function() {
        var detail = $(this).closest('.activity-photo');
        var updateType = detail.find('.update-type');
        if (updateType.val() === " . json_encode(ActivityPhoto::UPDATE_TYPE_UPDATE) . ") {
            //marking the row for deletion
            updateType.val(" . json_encode(ActivityPhoto::UPDATE_TYPE_DELETE) . ");
            detail.hide();
        } else {
...
<div class="activity-form">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            if ($model->isNewRecord) {
                ...
                <div class="col-md-6">
                    ...
                    <div id="image-box" class="col-md-12">
                        <br>
                        <?php
                        /* echo Html::img(Yii::$app->getHomeUrl() . 'uploads/activity/' . $model->main_photo,
                    ...
                    <div id="image-box" class="col-md-12">
                        ...
                        echo $form->field($model, 'main_photo_file')->widget(FileInput::classname(), [
                            'options' => ['accept' => 'image/*'], 'pluginOptions' => [
                                'showUpload' => false,
                                'initialPreview' => [
                                    ["http://www.designineducation.com/backend/uploads/activity/$model->main_photo"]
                                ],
            ...
            <div class="col-md-6">
                ...
                <?= $form->field($model, 'activity_type_id')->dropDownList(ArrayHelper::map(ActivityTypeLang::find()->all(), 'activity_type_id', 'name'), ['prompt' => '- Select -'])->label('Study Trip Category') ?>
            ...
            <div id="photo" class="tab-pane fade in active">
                <div class="row">
                    <?php foreach ($modelDetails as $i => $modelDetail) : ?>
                        <div class="activity-photo activity-photo-<?= $i ?>" style="margin-top: .75rem;">
                            <div class="col-md-5 col-xs-10">
                                ...
                                if(isset($modelDetail->photo_url)) {
                                    echo $form->field($modelDetail, "[$i]activity_photo")->widget(FileInput::classname(), [
                                        'options' => ['accept' => 'image/*'], 'pluginOptions' => [
                                            'showUpload' => false,
                                            'initialPreview' => [
                                                ["http://www.designineducation.com/backend/uploads/activity/related_photo/$modelDetail->photo_url"]
                                            ],
                                            'initialPreviewAsData' => true,
                                ...
                                //echo $form->field($modelDetail, "[$i]activity_photo")->fileInput() ?>
                            </div>
                            <div class="col-md-1 col-xs-2">
                                <?= Html::button('x', ['class' => 'delete-button-photo btn btn-danger', 'data-target' => "activity-photo-$i"]) ?>
                            </div>
                        </div>
                    <?php endforeach; ?>
  ...
  $(\'#media-selector\').change(function(){
   ...
   $(\'#image-box\').hide();
   $(\'#video-box\').show();
     $(\'#activity-media_type\').val(1);
    }else{
    
   $(\'#video-box\').hide();
   $(\'#image-box\').show();
    $(\'#activity-media_type\').val(2);
    }
    });
