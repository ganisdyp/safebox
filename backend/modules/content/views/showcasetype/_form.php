    ...
    <div class="row">
        <div class="col-md-9">
            ...
            <?php if ($model->isNewRecord) {
                ...
                /*  echo Html::img(Yii::$app->getHomeUrl() . 'uploads/showcase_type/' . $model->main_photo,
                      ['id' => 'current_img', 'class' => 'thumbnail', 'width' => '150']);*/
                echo $form->field($model, 'main_photo_file')->widget(FileInput::classname(), [
                    'options' => ['accept' => 'image/*'], 'pluginOptions' => [
                        'showUpload' => false,
                        'initialPreview' => [
                            ["http://www.designineducation.com/backend/uploads/showcase_type/$model->main_photo"]
                        ],
