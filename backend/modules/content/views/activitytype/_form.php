    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            if ($model->isNewRecord) {
                ...
                /* echo Html::img(Yii::$app->getHomeUrl() . 'uploads/activity_type/' . $model->main_photo,
                ...
                echo $form->field($model, 'main_photo_file')->widget(FileInput::classname(), [
                    'options' => ['accept' => 'image/*'], 'pluginOptions' => [
                        'showUpload' => false,
                        'initialPreview' => [
                            ["http://www.designineducation.com/backend/uploads/activity_type/$model->main_photo"]
                        ],
