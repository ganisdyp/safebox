  ...
  <div class="row">
    <div class="col-12 mb-4">
      <div class="section-title text-center viewpoint-animate d03s" data-animation="fadeInDown">
        <h2 class="letter-spacing-1 font-playfair"><?php echo Yii::t('common', 'service_title'); ?></h2>
        <hr class="mx-auto">
      </div>
      <div class="mt-4 viewpoint-animate d03s" data-animation="fadeIn">
        <?php
          echo '<p>'.Yii::t('common', 'service_content_1').'</p>';
          echo '<p>'.Yii::t('common', 'service_content_2').'</p>';
        ?>
      </div>
    </div>
  </div>
...
<div class="container">
  <div class="row justify-content-center my-5">
    <div class="col-12">
      ...
      <div class="mt-4 viewpoint-animate d03s" data-animation="fadeIn">
        <?php
          echo '<p>'.Yii::t('common', 'service_content_3').'</p>';
          echo '<p>'.Yii::t('common', 'service_content_4').'</p>';
        ?>
      </div>
    </div>
    <div class="col-lg-8">
    ...
    <div class="row viewpoint-animate d03s" data-animation="fadeIn">
      ...
      <div class="col-lg-4 mb-lg-0 mb-4">
        <div class="card card-event">
          ...
          <div class="card-image pos-rel">
            <div class="img-4by3 holder">
              <img class="card-img-top img-fluid" src="../images/service/repair-safe.jpg">
            </div>
          </div>
          <div class="card-body">
      ...
      <div class="col-lg-4 mb-lg-0 mb-4">
        <div class="card card-event">
          ...
          <div class="card-image pos-rel">
            <div class="img-4by3 holder">
              <img class="card-img-top img-fluid" src="../images/service/relocation-services.jpg">
            </div>
          </div>
          <div class="card-body">
