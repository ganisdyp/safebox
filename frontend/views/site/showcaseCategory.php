      ...
      <div class="row">
        <div class="col-lg-6 col-12 align-self-center">
          <div class="header-content">
            <p class="title h3 bold text-uppercase">Design Showcase</p>
  ...
  */ ?>
    <nav class="mt-2 fadeIn animated d07s">
        <ol class="breadcrumb smaller-90">
            ...
            <li class="breadcrumb-item active"><?php echo Yii::t('common', 'Design Showcase');?></li>
        </ol>
    </nav>
    <div class="row fadeIn animated d03s mt-3 mb-4">
        <?php foreach ($showcase_categories as $showcase_category) { ?>
        <div class="col-lg-4 col-md-6 col-12">
            <div class="card dc-card mb-4 corner-0 z-shadow fadeIn animated d03s">
                <a href="showcase-list?id=<?= $showcase_category->id; ?>&c=all" class="hover-box">
                    <div class="img-16by9 holder">
                        <img class="card-img-top img-responsive corner-0"
                                src="/backend/uploads/showcase_type/<?= $showcase_category->main_photo; ?>">
                    </div>
                </a>
                <div class="card-body text-center">
                    <a href="showcase-list?id=<?= $showcase_category->id; ?>&c=all"
                        class="card-title font-weight-normal bigger-110 my-0 block"><?= $showcase_category->name;?></a>
                </div>
            </div>
        </div>
        <?php } ?>
    ...
    <div class="row fadeIn animated d03s mt-3 mb-4">
        <?php foreach ($showcase_categories as $showcase_category) { ?>
            <div class="col-md-4 col-12">
                <a href="showcase-list?id=<?= $showcase_category->id; ?>&c=all" class="block mb-3">
                    <div class="media-wrapper corner-1">
                        <div class="img-16by9 holder corner-1">
                            <img class="card-img-top img-responsive" src="/backend/uploads/showcase_type/<?= $showcase_category->main_photo; ?>">
                        </div>
                        <p class="mb-0 bigger-120 font-weight-normal center bold"><?= $showcase_category->name;?></p>
